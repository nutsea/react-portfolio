...
import sprintgame from './../img/e-learning/SprintGame.png'
        ...
        <div className="E-global">
                            ...
                            <li className="E-games" onMouseEnter={showGames}>
                                ...
                                <div className="Games-menu-area" onMouseLeave={hideGames}>
                                    <div className="Games-menu">
                                        <button id="/e-sprint">Sprint ➔</button>
            ...
            <div className="E-nav-list Nav-hide">
                <ul>
                    ...
                    <li id="/e-textbook" onClick={handleNavigate}>Textbook</li>
                    <li id="/e-statistics" onClick={handleNavigate}>Statistics</li>
                    <li id="/e-sprint" className="E-place" onClick={eBurger}>Sprint</li>
            ...
            <div className="E-game-s-content">
                <div className="E-game-s-container">
                    <div className="E-game-s-pic"><img src={sprintgame} alt="sprintgame" /></div>
                    <div className="E-game-s-pic-small Small-sprint"><img src={sneakers} alt="sneakers" /></div>
                    <div className="E-game-s-text">
                        <div className="E-game-s-sub">
                            <div className="E-game-s-sub-text">Sprint</div>
                            <div className="E-game-s-sub-name">speed task</div>
                        </div>
